...
const clearColorFromCell = (colIndex) => {

    const openCell = getFirstOpenCellForCol(colIndex);

    openCell.classList.remove('yellow-faded');
    openCell.classList.remove('red-faded');
...
const handleCellMouseOver = (e) => {
    ...
    const availableCell = getFirstOpenCellForCol(colIndex);

    if(!availableCell) return;

    availableCell.classList.add(yellowIsNext ? 'yellow-faded' : 'red-faded');
